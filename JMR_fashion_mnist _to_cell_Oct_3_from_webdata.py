...
# Load the MNIST dataset -this works perfeclty i just wanted to not need internet :)
...
root = tk.Tk()
root.withdraw()
output_path_training = filedialog.askdirectory(title="Select output directory for training data")

# Create the output directory if it doesn't exist
if not os.path.exists(output_path_training):
    os.makedirs(output_path_training)

output_figure_dir = os.path.join(output_path_training, "NMIST_CELL_TRAINING_FIGURES")
